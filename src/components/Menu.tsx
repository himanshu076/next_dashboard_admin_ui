...
import { menuItems, role } from '@/utils/constants/constants'
                ...
                <div key={item.title} className='flex flex-col gap-2'>
                    ...
                    {item.items.map(subItem => (
                        subItem.visible.includes(role) && (
                            <Link key={subItem.lable} href={subItem.href} className='flex items-center justify-center lg:justify-start gap-4 text-gray-500 py-2 md:px-2 rounded-md hover:bg-lamaSkyLight'>
